...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает урон бойца по имени и классу."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает блокировку по имени и классу."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает специальный урон по имени и классу."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Возвращает начало тренировки по имени и классу."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Возвращает класс выбранного персонажа."""
    approve_choice: str = ''
    char_class: str = ''
